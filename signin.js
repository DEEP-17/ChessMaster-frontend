...
async function handleLogin(event) {
    ...
    try {
        ...
        console.log('Login status:', response.status); // Debug: Check status code
        const data = await response.json();
        console.log('Login response:', data); // Debug: Check full response

        if (response.ok) {
            // Store the entire user object from the server response
...
async function handleSignup(event) {
    ...
    try {
        ...
        console.log('Signup status:', response.status); // Debug: Check status code
        const data = await response.json();
        console.log('Signup response:', data); // Debug: Check full response
...
//         if (response.ok) {
//             // Store the entire user object from the server response in localStorage
//             localStorage.setItem('chessmaster_user', JSON.stringify(data.user));
